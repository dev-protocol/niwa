...
interface Web3ContextInterface {
  ...
  setWeb3Provider: React.Dispatch<
    React.SetStateAction<UndefinedOr<providers.Web3Provider>>
  >;
}

export function useWeb3ProviderContext(): Web3ContextInterface {
  const [web3Provider, setWeb3Provider] =
    useState<UndefinedOr<providers.Web3Provider>>(undefined);
...
export const WebProviderContext =
  React.createContext<Web3ContextInterface | null>(null);
